...
<link rel="stylesheet" href="{{asset('pageSale/slider/dist/assets/owl.carousel.min.css')}}">
<link rel="stylesheet" href="{{asset('pageSale/slider/dist/assets/owl.theme.default.min.css')}}">
